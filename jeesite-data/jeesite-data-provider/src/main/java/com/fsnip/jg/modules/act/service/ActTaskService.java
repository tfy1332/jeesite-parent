...
import com.fsnip.jg.common.utils.act.ActUtils;
import com.fsnip.jg.modules.act.dao.ActDao;
import com.fsnip.jg.modules.act.entity.Act;
import com.fsnip.jg.modules.act.service.cmd.CreateAndTakeTransitionCmd;
import com.fsnip.jg.modules.act.service.cmd.JumpTaskCmd;
import com.fsnip.jg.modules.act.service.creator.ChainedActivitiesCreator;
import com.fsnip.jg.modules.act.service.creator.MultiInstanceActivityCreator;
import com.fsnip.jg.modules.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import com.fsnip.jg.modules.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
import com.fsnip.jg.modules.act.utils.ProcessDefCache;
import com.fsnip.jg.modules.act.utils.ProcessDefUtils;
...
//					List<HistoricIdentityLink> il = historyService.getHistoricIdentityLinksForProcessInstance(procInsId);
					if (il.size() > 0){
						if (StringUtils.isNotBlank(il.get(0).getStartUserId())){
							User user = null;
//							UserUtils.getByLoginName(il.get(0).getStartUserId());
							if (user != null){
				...
				if (StringUtils.isNotEmpty(histIns.getAssignee())){
					User user = null;
//					UserUtils.getByLoginName(histIns.getAssignee());
					if (user != null){
						e.setAssignee(histIns.getAssignee());
						e.setAssigneeName(user.getName());
					}
