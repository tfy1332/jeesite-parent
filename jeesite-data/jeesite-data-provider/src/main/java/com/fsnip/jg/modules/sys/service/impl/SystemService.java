...
import com.fsnip.jg.common.security.Digests;
import com.fsnip.jg.common.service.CrudService;
import com.fsnip.jg.common.service.ServiceException;
...
//import com.fsnip.jg.modules.sys.utils.LogUtils;
...
public class SystemService extends CrudService<DictDao, Dict> implements ISystemService,InitializingBean {
...
////	}
	...
	public Page findPage(Page page, Object o) {
		return null;
	}
	...
	public void delete(Object entity, Boolean isRe) {

	}

	public List findList(Object o) {
		return null;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> findAllList(Menu entity) {
		return menuDao.findAllList(entity);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void afterPropertiesSet() throws Exception {
		...
		if (isSynActivitiIndetity){
			...
			// 同步用户数据
			List<org.activiti.engine.identity.User> userList = null;
...
//		identityService.saveGroup(group);
		...
		// 删除用户与用户组关系
		List<org.activiti.engine.identity.User> activitiUserList = null;
...
//		identityService.saveUser(activitiUser);
		...
		// 删除用户与用户组关系
		List<Group> activitiGroups = null;
