...
import com.fsnip.jg.modules.oa.service.leave.ILeaveService;
...
public class LeaveService extends BaseService implements ILeaveService {
...
//				ActUtils.PD_LEAVE[0], businessKey, processInstance.getId(), variables });
	...
	public void delete(Leave entity, Boolean isRe) {
