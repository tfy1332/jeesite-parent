...
//	private static OfficeDao officeDao = SpringContextHolder.getBean(OfficeDao.class);
    ...
    /**
     * Bean  Service  by tanfy 2017-05-15
     */
	...
	private static IOfficeService officeService = SpringContextHolder.getBean(IOfficeService.class);
	...
	public static List<Menu> getMenuList(){
		...
		if (menuList == null){
			User user = getUser();
			if (user.isAdmin()){
				menuList = menuService.findList(new Menu());
			}else{
				Menu m = new Menu();
	...
	public static List<Area> getAreaList(){
		...
		if (areaList == null){
			areaList = areaService.findList(new Area());
